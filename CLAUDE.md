...
## Project
Rapid-capture songwriting studio - A local-first, AI-assisted TUI that turns inspiration into captured lyrics in under a minute. Combines professional songwriting pedagogy with a high-performance terminal interface. Built with Go, Bubble Tea, whisper.cpp, and Ollama.
